...
public class MainActivity extends AppCompatActivity {
    ...
    ImageButton nextPokemonButton;
    ImageButton previousPokemonButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextPokemonButton = (ImageButton)findViewById(R.id.nextPokemonImageButtonId);
        previousPokemonButton =(ImageButton)findViewById(R.id.previousPokemonImageButtonId);
        ...
        if (savedInstanceState != null && savedInstanceState.containsKey("Saved")) {
            ...
            if (pokemonResult.getDetail() == null) {
                ...
                pokemonRankTextView.setText("" + pokemonResult.getId());
